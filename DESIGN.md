...
### Las lecciones
Arriba, una barra de avance como la de los juegos. Cada paso lo cuenta la mascota: ella a la izquierda (92 a 118px de alto) y lo que dice en un globo blanco con filo de 2px y la punta mirándola, a 1,15rem; sin título arriba. Si el paso trae una predicción, el globo tiene la pregunta y la mascota piensa; al contestar, el mismo globo arranca con la reacción (verde suave si pensó bien, crema si no) y sigue con la explicación. Abajo del globo, sobre el papel y sin tarjeta, el dibujo o la actividad; después el truco en crema y, separada por una línea punteada, la pregunta de práctica (sin cartelito arriba) con las mismas fichas de respuesta de la predicción. Una cuenta nunca se corta entre dos renglones.

Las actividades se arman con piezas que ya existen: tarjetas para escuchar (fichas con escalón y un parlantito en la esquina, de a dos por fila en el celular), las cosas de contar con su número, montoncitos con filo punteado de riel que se juntan en uno con filo verde, contadores «− 3 +» de botones redondos de 44px con escalón, la torta del juego de fracciones, grupos para ordenar (cajones con filo punteado que se ponen en celeste de selección mientras hay una ficha elegida), fichas pegadas para tocar la sílaba, barras de diez y cubitos en el azul y el girasol de los dibujos, y el mapa de los juegos quieto, con los continentes en sus colores. Debajo de cada actividad, un renglón centrado cuenta lo que pasó.

La lección cierra en una tarjeta blanca con la mascota festejando, «¡Aprendiste algo nuevo!» y dos o tres frases, cada una en su renglón con filo y una tilde verde, antes del ejercicio.
...
- **Don't** retar al que se equivoca: nada de «mal», «incorrecto», «no alcanzó», «¿seguro?» ni «te queda 1 intento». Siempre primero algo cálido, aunque el juego traiga su propio texto; después algo que enseñe y una invitación a probar otra vez. Al acertar, un festejo variado (nunca «¡Correcto!»).
- **Don't** mezclar al azar los botones cuando las respuestas son siempre las mismas categorías: van en su orden (herbívoro, carnívoro, omnívoro), para que se encuentren donde se dejaron.
