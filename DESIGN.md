...
### Las lecciones
Arriba, una barra de avance como la de los juegos. Cada paso lo cuenta la mascota: ella a la izquierda (92 a 118px de alto) y lo que dice en un globo blanco con filo de 2px y la punta mirándola, a 1,15rem; sin título arriba. Si el paso trae una predicción, el globo tiene la pregunta y la mascota piensa; al contestar, el mismo globo arranca con la reacción (verde suave si pensó bien, crema si no) y sigue con la explicación. Abajo del globo, sobre el papel y sin tarjeta, el dibujo o la actividad; después el truco en crema y, separada por una línea punteada, la práctica «¿Y vos?» con las mismas fichas de respuesta de la predicción. Una cuenta nunca se corta entre dos renglones.
