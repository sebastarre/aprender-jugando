...
window.Iconos = (function () {
  ...
  var DIBUJOS = {
    ...
    /* ---- La pizarra ---- */
    lapiz: {
      b: ['<path d="m4.6 19.4 1-4.1L15.8 5.1a2 2 0 0 1 2.9 0l.2.2a2 2 0 0 1 0 2.9L8.7 18.4Z"/>'],
      t: ['<path d="m4.6 19.4 1-4.1L15.8 5.1a2 2 0 0 1 2.9 0l.2.2a2 2 0 0 1 0 2.9L8.7 18.4Z"/>',
          '<path d="m13.9 7 3.1 3.1"/>']
    },
    goma: {
      b: ['<path d="m4.9 15.1 9-9a2 2 0 0 1 2.8 0l2.2 2.2a2 2 0 0 1 0 2.8l-8.3 8.4H9Z"/>'],
      t: ['<path d="m4.9 15.1 9-9a2 2 0 0 1 2.8 0l2.2 2.2a2 2 0 0 1 0 2.8l-8.3 8.4H9Z"/>',
          '<path d="m9.6 10.4 5 5"/>',
          '<path d="M10.6 19.5h9"/>']
    },
    deshacer: {
      b: [],
      t: ['<path d="M9.2 6.4 4.5 11.1l4.7 4.7"/>',
          '<path d="M4.8 11.1h9.4a5 5 0 0 1 0 10h-2.7"/>']
    },
    basura: {
      b: ['<path d="m6.4 7 .9 12.3A1.8 1.8 0 0 0 9.1 21h5.8a1.8 1.8 0 0 0 1.8-1.7L17.6 7Z"/>'],
      t: ['<path d="M4.5 7h15"/>',
          '<path d="M9.5 7V5.2A1.2 1.2 0 0 1 10.7 4h2.6a1.2 1.2 0 0 1 1.2 1.2V7"/>',
          '<path d="m6.4 7 .9 12.3A1.8 1.8 0 0 0 9.1 21h5.8a1.8 1.8 0 0 0 1.8-1.7L17.6 7"/>',
          '<path d="M10.2 10.6v6.4M13.8 10.6v6.4"/>']
    },

    /* La llamita de la racha. */
    fuego: {
      b: ['<path d="M12 21.5c-3.9 0-6.5-2.6-6.5-6.2 0-3.3 2.2-5.2 3.6-7.6.3 1.7 1.2 2.9 2.3 3.4.2-3 1.5-5.6 4-7.6-.2 2.7.6 4.4 1.9 6.1 1.1 1.5 1.7 3 1.7 5.1 0 3.9-2.9 6.8-7 6.8Z"/>'],
      t: ['<path d="M12 21.5c-3.9 0-6.5-2.6-6.5-6.2 0-3.3 2.2-5.2 3.6-7.6.3 1.7 1.2 2.9 2.3 3.4.2-3 1.5-5.6 4-7.6-.2 2.7.6 4.4 1.9 6.1 1.1 1.5 1.7 3 1.7 5.1 0 3.9-2.9 6.8-7 6.8Z"/>']
    },
